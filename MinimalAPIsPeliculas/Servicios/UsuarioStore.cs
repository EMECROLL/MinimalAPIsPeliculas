...
namespace MinimalAPIsPeliculas.Servicios
{
    public class UsuarioStore : IUserStore<IdentityUser>,
        IUserEmailStore<IdentityUser>, IUserPasswordStore<IdentityUser>, IUserClaimStore<IdentityUser>
    {
        ...
        public Task SetNormalizedEmailAsync(IdentityUser user, 
        ...
        public Task SetNormalizedUserNameAsync(IdentityUser user, 
        ...
        public Task SetPasswordHashAsync(IdentityUser user, 
